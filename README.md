...
Capture screen text via OCR straight to your clipboard
...
├── arch-go.yml             # Architecture rules configuration
...
- Install development tools (gofumpt, gosec, staticcheck, golangci-lint, govulncheck, arch-go)
